...
import { verifyEmailToken } from "~/lib/email.server";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  if (!token) {
    return json({ verified: false, error: "No verification token provided" });
  }
  ...
  const sessionToken = createUserSession(result.userId!);
          ...
          <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
            <div className="card text-center">
              ...
              <div className="space-y-3">
                <Link to="/resend-verification" className="btn-primary w-full">
    ...
    <div className="min-h-screen bg-sunrise-50">
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="card text-center">
          ...
          <p className="mt-4 text-charcoal-700">Verifying your email...</p>
        </div>
      </div>
      <Footer />
    </div>
